...
% Define font for section numbers
\titleformat{\section}
  {\normalfont\bfseries\fontfamily{ptm}\selectfont\Large}
  {\thesection}{1em}{}

% Define font for subsection numbers
\titleformat{\subsection}
  {\normalfont\bfseries\fontfamily{ptm}\selectfont}
  {\thesubsection}{1em}{}
...
\titleformat{\subsubsection}
  ...
  {\thesubsubsection}{1em}{}
%=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=
% ALTERAÇÃO DO COMANDO LISTA DE ILUSTRAÇÕES
...
%=====================================================================  
% SUMÁRIO (Elemento pré-textual - contado mas não numerado)
